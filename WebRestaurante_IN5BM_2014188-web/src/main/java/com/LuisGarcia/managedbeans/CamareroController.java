package com.LuisGarcia.managedbeans;

import com.LuisGarcia.Camarero;
import com.LuisGarcia.managedbeans.util.JsfUtil;
import com.LuisGarcia.managedbeans.util.JsfUtil.PersistAction;
import com.LuisGarcia.sessionsbeans.CamareroFacadeLocal;
...
public class CamareroController implements Serializable {
    ...
    @EJB
    private CamareroFacadeLocal ejbFacade;
    ...
    private CamareroFacadeLocal getFacade() {
        return ejbFacade;
    }
